...
```bash
git clone https://github.com/ahmedabbas358/Ml-PRJ
...
- **Ahmed Abbas** - *Initial work* - SAIR ML Course Final Project
...
- GitHub: [@ahmedabbas358](https://github.com/ahmedabbas358)
- LinkedIn: [Ahmed Abbas](https://linkedin.com/in/ahmed-abbas-049141248)
...
- [Project Repository](https://github.com/ahmedabbas358/Ml-PRJ)
